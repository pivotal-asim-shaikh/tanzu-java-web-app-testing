...
```json
{
  "projectName" : "tanzu-java-web-app-testing",
  "repositoryPrefix" : "asimfed.com"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-app-t...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->asimfed.com]
